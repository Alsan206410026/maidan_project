...
function AdminDashboard() {
  ...
  const fetchDashboard = async () => {
    try {
      // Replace with your admin endpoint
      ...
      const todayBookingList = bookingData.filter(
        (booking) =>
          booking.date &&
          booking.date.substring(0, 10) === today
      );
      ...
      setStats({
        ...
        todayBookings: todayBookingList.length,
        revenue,
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-2 text-gray-500">
          Welcome back! Here's an overview of your futsal venue.
        </p>
      </div>
        ...
        {statsData.map((item) => (
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <div
                className={`rounded-full p-4 text-3xl ${item.color}`}
              >
                {item.icon}
              </div>
