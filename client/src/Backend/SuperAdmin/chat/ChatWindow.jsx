      ...
      <div className="border-t bg-white p-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="flex-1 rounded-xl border border-gray-300 px-4 py-3 outline-none transition focus:border-green-600"
          />

          <button
            onClick={handleSend}
            className="rounded-xl bg-green-600 p-4 text-white transition hover:bg-green-700"
          >
            <FaPaperPlane />
          </button>
